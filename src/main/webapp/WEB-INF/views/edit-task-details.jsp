...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	...
	<div class="container mt-5 p-4" style="max-width: 600px; border: 1px solid #ccc; border-radius: 8px;">
		<form action="/todo-list/edittask" method="POST">
		  <div class="form-group">
		    <label for="taskName">Task Name</label>
		    <input type="text" class="form-control" id="taskName" name="taskName" placeholder="${task.getTaskName()}">
		  </div>
		  <div class="form-group">
		    <label for="taskDescription">Task Description</label>
		    <input type="text" class="form-control" id="taskDescription" name="taskDescription" placeholder="${task.getTaskDescription()}">
		  </div>
